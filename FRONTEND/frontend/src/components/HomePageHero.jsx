    ...
    <div className="text-center">
      ...
      <form onSubmit={handleCourseGeneration} className="mt-10 max-w-xl mx-auto">
        <div className="relative">
          ...
          <button
            type="submit"
            className="absolute right-2 top-1/2 -translate-y-1/2 bg-blue-600 text-white font-bold px-6 py-2 rounded-md shadow-lg hover:bg-blue-700 transition-all transform hover:scale-105"
          >
            Create
          </button>
        </div>
